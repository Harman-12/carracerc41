...
function preload() {
  ...
  carsound = loadSound("Sports-Car-Driving-Loud-www.fesliyanstudios.com.mp3")
}
...
function setup() {
  ...
  player_car = new Car(mouseX, 300, 150, 150);

  enemy_x = Math.round(random(50, 750));

  enemy = new Enemy(enemy_x, 0, 150, 150);
...
function switchImg() {
  var random_animation = Math.round(random(1,3));
    switch(random_animation) {
      case 1: enemy.animation = loadImage("images/greycar.png");
              break;
      case 2: enemy.animation = loadImage("images/redcar.png");
              break;
      case 3: enemy.animation = loadImage("images/yellowcar.png");
              break;
      default: break;
    }
}
